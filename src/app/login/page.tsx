      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="glass-card bg-[#0f172a]/80 backdrop-blur-2xl p-6 sm:p-10 md:p-12 shadow-[0_40px_100px_rgba(0,0,0,0.4)] border border-white/5 relative overflow-hidden">
          ...
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-black text-white tracking-tight mb-2">Initialize Session</h2>
            <p className="text-sm text-slate-500 font-bold uppercase tracking-wider">Access your professional portfolio</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            >
              ...
              {loading ? "PROCESSING..." : "Authorize Portal"}
            </button>
          </form>
          ...
          <div className="mt-10 pt-10 border-t border-white/5 text-center">
            <p className="text-xs font-black text-slate-500 uppercase tracking-widest">
              ...
              <Link href="/signup" className="text-primary hover:text-indigo-400 transition-colors">
                Initialize Account
              </Link>
            </p>
          </div>
